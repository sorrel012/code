...
public class AjaxDAO {
    ...
    public int addAddress(AddressDTO dto) {
        ...
        try {
            ...
            String sql = "insert into ajaxList(seq, name, tel, address) values(listseq.nextVal, ?, ?, ?) ";
    ...
    public String getAddress() {
        ...
        try {
            ...
            String sql = "select max(seq) as max from ajaxList";
    ...
    public int delAddress(String seq) {
        ...
        try {
            ...
            String sql = "delete from ajaxList where seq = ?";
