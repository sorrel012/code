...
<script>
   ...
   function editok(seq) {
       ...
       $.ajax({           
           ...
           success: (result)=>{
               ...
               $(btn).parent().parent().parent().children().eq(2).text(parseInt(Number(price)).toLocaleString() + "원"); 
   ...
   function cancel() {
      ...
      $(event.target).parent().parent().parent().children().eq(1).text(tmp_name);   
      
      $(event.target).parent().parent().parent().children().eq(2).text(tmp_price); 
      
      $(event.target).parent().parent().parent().children().eq(3).text(tmp_color);  
